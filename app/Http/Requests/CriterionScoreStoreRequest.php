...
class CriterionScoreStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'criterion_id'        => [
                ...
                'integer',
                'exists:criteria,id',
                Rule::unique('criterion_scores')->where(fn ($query) => $query->where('reporting_period_id', $this->input('reporting_period_id'))),
            ],
