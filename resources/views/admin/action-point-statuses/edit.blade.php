<x-layouts::app :title="__('Status bewerken')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Status bewerken: {{ $actionPointStatus->name }}</h1>
        ...
        <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
            <form action="{{ route('admin.action-point-statuses.update', $actionPointStatus) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        name="name"
                        id="name"
                        value="{{ old('name', $actionPointStatus->name) }}"
