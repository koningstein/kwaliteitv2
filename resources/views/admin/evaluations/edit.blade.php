<x-layouts::app :title="__('Evaluatie bewerken')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Evaluatie bewerken</h1>
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        @foreach($actionPoints as $actionPoint)
                            <option value="{{ $actionPoint->id }}" {{ old('action_point_id', $evaluation->action_point_id) == $actionPoint->id ? 'selected' : '' }}>
