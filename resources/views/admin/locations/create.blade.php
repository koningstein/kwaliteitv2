<x-layouts::app :title="__('Locatie aanmaken')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Nieuwe locatie</h1>
            ...
            <form action="{{ route('admin.locations.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="name"
                        value="{{ old('name') }}"
                        placeholder="Bijv. Schiedamseweg 245"
