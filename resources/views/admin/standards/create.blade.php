<x-layouts::app :title="__('Standaard aanmaken')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Nieuwe standaard</h1>
            ...
            <form action="{{ route('admin.standards.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="name"
                        value="{{ old('name') }}"
                        placeholder="Bijv. De instelling heeft een BPV-beleid"
                        class="w-full rounded-lg border border-zinc-300 bg-white px-4 py-2 text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-100"
                        required
                    />
                    @error('name')
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        id="description"
                        rows="4"
                        placeholder="Optionele toelichting bij deze standaard..."
                        class="w-full rounded-lg border border-zinc-300 bg-white px-4 py-2 text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-100"
