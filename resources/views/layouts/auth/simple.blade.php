...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-slate-50 font-sans antialiased">
        ...
        {{-- Auth form gecentreerd --}}
        <div class="flex min-h-[calc(100vh-65px)] flex-col items-center justify-center px-4 py-12">
            <div class="w-full max-w-sm">

                {{-- Logo-badge boven het formulier --}}
                <div class="flex flex-col items-center mb-8">
                    <div class="w-14 h-14 rounded-2xl bg-blue-600 flex items-center justify-center shadow-md mb-4">
